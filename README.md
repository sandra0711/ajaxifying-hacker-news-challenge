...
3. Затем должен отправить запрос AJAX на сервер по адресу '/posts/:id/vote' с правильным значением идентификатора.
...
Вам нужно будет изменить маршрут сообщения '/posts/:id/vote' и написать некоторый клиентский JavaScript, чтобы это заработало.
